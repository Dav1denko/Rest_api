...
func (r *TodoListPostgres) GetById(userId, listId int) (restapi.TodoList, error) {
...
func (r *TodoListPostgres) Update(userId, listId int, input restapi.UpdateListInput) error {
